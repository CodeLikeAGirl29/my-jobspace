...
/**
 * Renders a Job component.
 *
 * @param {object} _id - The unique ID of the job.
 * @param {string} position - The position of the job.
 ...
 * @param {string} createdAt - The creation date of the job.
